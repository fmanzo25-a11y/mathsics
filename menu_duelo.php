...
<body class="flex items-center justify-center min-h-screen p-4 relative">
    ...
    <div id="seleccion-panel" class="w-full max-w-2xl glass-panel rounded-3xl p-8 transition-all duration-300 border-t-4 border-orange-400">
        <div class="text-center mb-8">
            <i class="fas fa-swords text-5xl text-orange-500 mb-2 drop-shadow-md"></i>
    ...
    <div id="buscando-panel" class="w-full max-w-3xl text-center transition-all duration-300 hidden glass-panel rounded-3xl p-8 border-t-4 border-blue-400">
