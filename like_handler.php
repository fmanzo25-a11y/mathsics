...
try {
    ...
    if ($existingLike) {
        ...
        // NOTA: El decremento del contador en posts se hace automáticamente vía trigger (disminuir_like_post)
        $liked = false;
    } else {
        ...
        // NOTA: El incremento del contador en posts se hace automáticamente vía trigger (aumentar_like_post)
        $liked = true;
    }
